...
# 
# # Debugging---------
# setwd('/work/DPDS/s438167/spacia')
# spacia_path = './spacia/'
# beta_dir = '/project/shared/xiao_wang/projects/cell2cell_inter/data/shijia_simulation/spacia_base_3_pathways_Ntotal_50000Nwarm_20000/base_3_pathways_Ntotal_50000Nwarm_20000_beta.txt'
# b_dir = '/project/shared/xiao_wang/projects/cell2cell_inter/data/shijia_simulation/spacia_base_3_pathways_Ntotal_50000Nwarm_20000/base_3_pathways_Ntotal_50000Nwarm_20000_b.txt'
# 
# beta <- read.table(beta_dir, sep="\t", header=TRUE)
# b <- read.table(b_dir, sep="\t", header=TRUE)
# 
# # # as.matrix since we want column names
...
# 
# # test small nbeta
# beta_matrix = as.matrix(beta)[,1:4] 
# # test large nbetas
# beta_matrix = cbind(as.matrix(beta), as.matrix(beta)[,1:15]) 
# colnames(beta_matrix) = paste("beta.", 1:dim(beta_matrix)[2], sep="")
# 
